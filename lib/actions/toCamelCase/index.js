...
function toCamelCaseGoogle(string) {
  return string.indexOf('-') < 0 ? string : string.replace(/-[a-z]/g, function(m) {
...
const toCamelCase = function () {
  return function(origin) {
    return eachKeys(origin, function(key, value){
      return {key: camelCase(key), value: value};
    });
  };
};
